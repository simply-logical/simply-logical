...
a. the body is **true**, and the head is **true**;
b. the body is **true**, and the head is **false**;
c. the body is **false**, and the head is **true**;
d. the body is **false**, and the head is **false**.
...
```{figure} ../images/part_i/image016.svg
---
name: 2.1
width: 100%
---
...
```{figure} ../images/part_i/image018.svg
---
name: 2.2
width: 100%
---
